      ...
      <form action="addcustomer.php" method="post" class="form-signin">
        ...
        <?php if(isset($customer_ID)) echo "<input type='hidden' name='customer_ID' value=" . $customer_ID ." >"; ?>
          ...
          <div class="customerform">
              ...
              <input type="name" name="firstname" value="" required pattern="[A-Za-z]" class="form-control" <?php if (isset($customer['firstname'])) echo "value='" . $customer['firstname'] . "'"; ?> />
          </div>

          <div class="customerform">
              <label for="lastname">Lastname:</label>
              <input type="name" name="lastname" value="" required pattern="[A-Za-z]" class="form-control" <?php if (isset($customer['lastname'])) echo "value='" . $customer['lastname'] . "'"; ?> />
          </div>
          ...
          <div class="customerform">
            ...
            <input type="text" name="phone" value="" required placeholder="Enter a valid phone number" pattern="[0-9]" class="form-control" <?php if (isset($customer['phone'])) echo "value='" . $customer['phone'] . "'"; ?> />
          </div>

          <div class="customerform">
            <label for="address">Address:</label>
            <input type="text" name="address" value="" required  pattern="[A-Za-z-0-9]+\s[A-Za-z-'0-9]+" class="form-control" <?php if (isset($customer['address'])) echo "value='" . $customer['address'] . "'"; ?> />
          </div>
          ...
          <div class="customerform">
            ...
            <input type="text" name="phone" required pattern="[0-9]" value="" class="form-control" <?php if (isset($customer['zip'])) echo "value='" . $customer['zip'] . "'"; ?> />
          </div>

          <div class="customerform">
            <label for="state">State:</label>
            <input type="text" name="state" value="" required pattern="[A-Za-z]" class="form-control" <?php if (isset($customer['state'])) echo "value='" . $customer['state'] . "'"; ?> />
          </div>
